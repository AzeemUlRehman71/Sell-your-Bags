...
class ClientController extends Controller
{
   ...
   // dd($realPath);
        ...
        $lastId = $client->id;
        $condition = $input['productPrice'];
     //   dd($condition);
        foreach($condition as $index => $condition){
          //  dd($input['productPrice'][$index]);
    ...
    if ($request->hasFile(['productImage'])) {
        ...
        foreach ($images as $key => $file) {
            ...
            //     $constraint->aspectRatio();
            // });
            // $image->save(public_path('/app-assets/images/products/' . time() . '.png'));
            // $realPathProduct =$image->getPathname();
        ...
        // $originalPath = public_path().'/images/';
          ...
          // dd($lastId);
           ...
           //return redirect()->route('sellyourbags.thankyou')->with(['id'=>$lastId]);
