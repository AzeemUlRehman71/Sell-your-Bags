...
class ClientController extends Controller
{
     ...
     */
     ...
     $path = 'posts/tmp/'.$id.'/presentation_1.png';
      ...
      //  dd($path->getMimeType());
       ...
       // 'posts/'. $tmp_file->folder, '/' .$tmp_file->file);
      // dd($path);
       //  $path = storage_path().'/posts/tmp/post6399a382b84b74.95403853/presentation_1.png';
    ...
    {  
     ...
     //  dd($tmp_file);
       ...
       //  dd(storage_path().'/app/posts/tmp/'. $tmp_file->folder,'/' .$tmp_file->file);
        //  dd('app/idcard/'. $tmp_file->folder, '/' .$tmp_file->file);
        //Storage::copy('/app/public/posts/tmp'. $tmp_file->folder, '/' .$tmp_file->file,'posts/'. $tmp_file->folder, '/' .$tmp_file->file);
     ...
     // dd($realPath1);
      ...
      //  $validated = $request->validated();
        ...
        $client->id_card_image =$realPath1;
