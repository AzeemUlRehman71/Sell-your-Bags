                    ...
                    <div class="row my-5 abc">
                        <div class="col-md-2">
                            <label>
                                ...
                                <input type="file" name="productImage[]" id="productImage" class="form-control d-none" />
                            </label>
                        </div>
                        <div class="col-md-3">
        ...
        <div class="row py-5 bg-white" id="direct">
            <div class="col-md-12">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <label class="fw-bold my-2">FIRST NAME<span class="text-danger">*</span></label>
            ...
            <div class="col-md-12 pt-3">
                <div class="row pt-3">
                    ...
                    <div class="col-md-4">
                        <label class="fw-bold my-2">PHONE NUMBER<span class="text-danger">*</span></label>
                    ...
                    <div class="col-md-1"></div>
                    <div class="col-md-4">
                        <label class="fw-bold my-2">ACCOUNT NUMBER<span class="text-danger">*</span></label>
            ...
            <div class="col-md-12 pt-3">
                <div class="row pt-3">
                    ...
                    <div class="col-md-4">
                        <label class="fw-bold my-2">ROUTING NUMBER<span class="text-danger">*</span></label>
                    ...
                    <div class="col-md-1"></div>
                    <div class="col-md-4">
                        <label class="fw-bold my-2">ACCOUNT TYPE<span class="text-danger">*</span></label>
            ...
            <div class="col-md-12 pt-3">
                <div class="row pt-3">
                    ...
                    <div class="col-md-4">
                        <label class="fw-bold my-2">BANK NAME<span class="text-danger">*</span></label>
