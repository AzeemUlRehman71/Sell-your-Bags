    ...
    <form method="POST" action="{{ route('sellyourbags.store') }}" enctype="multipart/form-data">
        ...
        <div class="row bg-white">
            ...
            <div class="row my-5">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control shadow-none" placeholder="Enter Your Phone" name="phone"
            ...
            <div class="row my-5 flex-d justify-content-between">
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control shadow-none" placeholder="Enter Your Address" name="address">
                </div>
                <div class="col-md-4">
                    ...
                    <input type="file" class="form-control" name="id_card_image" id="id_card_image"
                        value="{{ old('id_card_image') }}" required />
            ...
            <div class="col-md-12 bg-white px-5">
                ...
                <div class="" id="dataAdd">
                    <div class="row my-5 abc">
                        ...
                        <div class="col-md-3">
                            <input type="number" class="form-control productPrice" placeholder="$ 0.00" value="0"
        ...
        <div class="row justify-content-end pb-5 bg-white px-3">
            <div class="col-md-4">
                ...
                <br />
                <button id="clear" class="btn btn-danger btn-sm">Clear Signature</button>
                <textarea id="signature64" name="signature64" style="display: none"></textarea>
