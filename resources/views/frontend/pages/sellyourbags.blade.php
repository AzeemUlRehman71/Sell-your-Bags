   ...
   <form method="POST" action="{{ route('sellyourbags.store') }}" class="dropzone-area" id="clientform"
         ...
         <div class="col-md-4 text-align-right py-4">
            <div id="new" class="total d-flex justify-content-start">
               <label for="floatingInput" id="" class="fw-bold text-green fs-6 total-left">TOTAL :
                  $</label>
               <input type="number" class="form-control total-right noscroll" name="grand_total" id="grand_total" />
      ...
      <div class="row d-flex justify-content-start bg-white px-3">
         <div class="col-md-4 py-5">
            ...
            <select class="form-select shadow-none" aria-label="Default select example" name="payment_method"
               ...
               <option value="paypal" @if (old('payment_method')=='paypal' ) {{ 'selected' }} @endif>Paypal
               </option>
               <option value="cheque" @if (old('payment_method')=='cheque' ) {{ 'selected' }} @endif>Cheque
               </option>
               <option value="echeck" @if (old('payment_method')=='echeck' ) {{ 'selected' }} @endif>E-check
               </option>
               <option value="direct" @if (old('payment_method')=='direct' ) {{ 'selected' }} @endif>Direct Deposit
               </option>
               <option value="storecredit" @if (old('payment_method')=='storecredit' ) {{ 'selected' }} @endif>Store
                  Credit
               </option>
            </select>
      ...
      <div class="col-md-12 pt-3">
		...
		<label class="fw-bold my-2">RE-ENTER ACCOUNT NUMBER</label>
               <input type="text" onpaste="return false;" ondrop="return false;" autocomplete="off" class="form-control" name="payment_direct_re_enter_account_number"
		  id="payment_direct_re_enter_account_number" value="{{ old('payment_direct_re_enter_account_number') }}" />
...
<div class="row py-5 d-flex flex-column bg-white px-3">
   <div class="row">
      <div class="col-md-4">
         <input class="form-check-input" type="checkbox" @if (old('disclaimer')) checked @endif id="disclaimer"
...
<div class="row justify-content-center pb-5 bg-white px-3">
   ...
   <div class="col-md-4">
      <label class="fw-bold d-block">SIGNATURE:</label><span class="text-danger fw-lighter" style="font-size:11px;">You
         must provide your
         signature.</span>
...
<div class="row justify-content-end pb-5 bg-white px-3">
   <div class="col-md-3 d-grid">
      <button class="btn btn-success btn-lg  submit bg-add" type="submit"><span class="btn-txt">SUBMIT</span>
