...
@section('content')
    <div class="row">
        <form method="POST" action="{{ route('sellyourbags.store') }}" class="dropzone-area" id="clientform"
            ...
            @csrf
            <div class="row">
                <div class="col-md-12 mt-5 mb-2 px-0">
                        ...
                        <div class="row my-5 abc">
                            ...
                            <div class="col-md-2">
                                <input type="number" class="form-control productPrice" placeholder="$ 0.00"
                                    value="" name="products[0]['price']" id="productPrice" required />
                            </div>
                            <div class="col-md-1">
            ...
            <div class="row py-5 bg-white" id="cheque">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" name="payment_full_name_cheque"
                        id="payment_full_name_cheque" value="{{ old('payment_full_name_cheque') }}" />
            ...
            <div class="row py-5 bg-white" id="echeck">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" name="payment_full_name_echeck"
                        id="payment_full_name_echeck" value="{{ old('payment_full_name_echeck') }}" />
                    {{-- @if ($errors->has('payment_full_name_cheque'))
                    <span class="error">{{ $errors->first('payment_full_name_cheque') }}</span>
                @endif --}}
            ...
            <div class="row justify-content-center pb-5 bg-white px-3">
                <div class="col-md-4">
                    <label class="fw-bold">SIGNATURE:</label><span class="text-danger fw-lighter"
